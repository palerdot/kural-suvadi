( function ( $ ) {
	...
	IMESelector.prototype = {
		 ...
		 */
		helpLink: function () {
		    // change the help link to display the 'kural petti' help link
			return $( '<div class="ime-help-link selectable-row">' )
				.append( $( '<a id="ime-help-link" class="ime-udhavi">' ).text( 'உதவி' )
					.addClass( 'selectable-row-item' )
					.attr( {
						'href': '#'
					} )
	...
	IMESelector.defaults = {
		defaultLanguage: 'en',
		// Milliseconds after which IME widget hides itself
		// [Arun] we do not want this as this shows during orientation change
		timeout: 0 
	};
	...
	function languageListTitle() {
	    return false;
	    // not required to display the other languages menu
		return $( '<h3>' )
	...
	function toggleMenuItem() {
	    return false;
	    // no need to display the 'ime disabling' link
